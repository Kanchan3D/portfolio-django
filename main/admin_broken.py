...
def mongodb_status_view(request):
    ...
    try:
        ...
        <div style="background: #d4edda; border: 1px solid #c3e6cb; padding: 15px; border-radius: 5px; margin: 20px 0;">
            ...
            <p style="color: #155724; margin: 5px 0;">📄 Certificates: {certificates_count} documents</p>
            <p style="color: #155724; margin: 5px 0;">🚀 Projects: {projects_count} documents</p>
            <p style="color: #155724; margin: 5px 0;">📝 CVs: {cvs_count} documents</p>
            <hr style="border-color: #c3e6cb;">
            <p style="color: #155724; margin: 5px 0;"><strong>💡 Management Commands:</strong></p>
            <ul style="color: #155724; margin: 10px 0; padding-left: 20px;">
                <li>Add Certificate: <code>python manage.py shell -c "from main.models import Certificate; ..."</code></li>
                <li>Add Project: <code>python manage.py shell -c "from main.models import Project; ..."</code></li>
                <li>View Portfolio: <a href="/" target="_blank">Portfolio Home</a></li>
                <li>View Certificates: <a href="/certification/" target="_blank">Certificates Page</a></li>
                <li>View Projects: <a href="/projects/" target="_blank">Projects Page</a></li>
            </ul>
        </div>
        """
        
        messages.success(request, format_html(status_html))
        ...
        """
        messages.error(request, format_html(error_html))
    
    # Return the default admin index view
